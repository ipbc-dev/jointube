  ...
  export default {
    ...
    data: function () {
      return {
        ...
        stepsContent: [
          this.$gettext(`
            Lorsqu’on recherche des vidéos sur une instance PeerTube aujourd’hui,
            ...
            public</a>.
            Le code de ce moteur d’indexation sera libre, afin que quiconque
            ...
            recherche</strong> de son instance.
            Par ailleurs, <strong>les messages d’information</strong>
            permettront aux administrateurs d’une instance d’afficher une
            information aux personnes qui la visitent.
          `),
          this.$gettext(`
            Bien que chaque nouvelle version de PeerTube ait apporté <a
            ...
            de nouveaux outils de modération</strong>.
            La liste des fonctionnalités à développer ou à améliorer est longue :
            ...
            spams</strong>, partage de listes noires d’instances, de comptes, de contenus…
            Cette liste se construit <a href="https://github.com/Chocobozzz/PeerTube/labels/Component%3A%20Moderation%20%3Agodmode%3A">
            <strong>en collaboration avec la communauté</strong></a>,
            et c’est à l’écoute de ces besoins que nous essaierons de prioriser
            les outils de modération développés durant ce mois.
          `),
          this.$gettext(`
            S’il est facile d’intégrer une vidéo PeerTube sur un site web ou dans des médias sociaux,
            on ne peut pas en dire autant des listes de lectures.
            Nous voulons <strong>retravailler l’intégration et l’affichage des
            playlists</strong> sur les sites tiers.
            Nous souhaitons aussi permettre l’<strong>affichage de deux extraits d’une
            ...
            pour des usages pédagogiques.
            Les plugins permettent à quiconque de contribuer, en codant de
            ...
            Afin de se mettre à leur place, nous allons nous-mêmes en créer
            ...
            précis du visionnage.
            Nous voulons enfin travailler à <strong>sélectionner un ensemble de plugins
            pour les mettre en valeur</strong> sur joinpeertube.org.
          `),
          this.$gettext(`
            Le plus gros défi du direct sur PeerTube, c’est de <strong>faire en sorte
            que le live soit diffusé en pair-à-pair</strong>. Après de nombreux tests,
            nous pensons que c’est possible.
            En utilisant la technologie HLS intégrée au lecteur vidéo de PeerTube
            ...
            ni d’émoticônes pour réagir…
            Cependant, nous voulons faire en sorte qu’<strong>une fois le live fini,
            la vidéo sera traitée et ajoutée à la chaîne du vidéaste</strong>, ce en
            respectant les impératifs pour que tout soit correctement fédéré.
          `)
        ]
      }
    }
